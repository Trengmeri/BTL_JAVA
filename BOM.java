...
public class BOM extends JPanel {
    ...
    public BOM() {
        // Load sprite sheet
        ImageIcon icon = new ImageIcon("D:\\Kunny_1\\Kunny_1\\src\\main\\java\\animation\\weapon\\BOM.png");
    ...
    private static  void playBackgroundMusic() {
        String soundFilePath = "D:\\Kunny_1\\Kunny_1\\src\\main\\java\\image\\101 (online-audio-converter.com).wav"; // Thay đổi đường dẫn tương ứng với tệp nhạc của bạn
        try {

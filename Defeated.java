...
public class Defeated extends JPanel {
    ...
    private void addTitleLabel() {
        // Tạo nhãn văn bản
        JLabel titleLabel = new JLabel("DEFEATED");
    ...
    private void addButtons() {
        ...
        ImageIcon icon1 = new ImageIcon("D:\\Kunny_1\\Kunny_1\\src\\main\\java\\image\\backBT.png");

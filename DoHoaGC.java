...
//
//import animation.Chic_At;
//import animation.chic_run;
//import animation.stand;
//import animation.MoveCharacter_Boy;
//import animation.stand_left;
//import animation.move_left;
//
...
//        g2d.drawImage(vongngam, player.getPlayerX() - 80, player.getPlayerY() - 80, 300, 300, this);
//        // Vẽ thước ngắm
//        bar.paintComponent(g, player.getPlayerX() + 70, player.getPlayerY() + 70);
//        // Vẽ player
...
//            bar.setAngle((bar.getAngle() + 10) % 360 ); // Tăng góc lên 10 độ
//            repaint(); // Vẽ lại thanh
//        } else if (keyCode == KeyEvent.VK_UP) {
//            bar.setAngle((bar.getAngle() - 10 + 360) %360); // Giảm góc đi 10 độ
//            repaint(); // Vẽ lại thanh
//        }
//        
//        
...
//                if(boss.getBossX() == player.getPlayerX() && boss.getBossY() == player.getPlayerY()){
//                    boss.setIsAttacking(true);
//                    attack.setX(boss.getBossX());
//                    attack.setY(boss.getBossY());
//                    break;
//                }

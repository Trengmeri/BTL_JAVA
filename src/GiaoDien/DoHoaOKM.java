...
public class DoHoaOKM extends JFrame implements KeyListener {
    ...
    public DoHoaOKM() {
        ...
        try {
            // Load ảnh
        	backGroundOKM = new ImageIcon("image\\imagesOKM\\backGroundOKM.jpg").getImage();
            DiaHinhOKM = new ImageIcon("image\\imagesOKM\\DiaHinhOKM.png").getImage();
            DaoTrenKhongOKM = new ImageIcon("image\\imagesOKM\\DaoTrenKhongOKM.png").getImage();
            TenMapOKM = new ImageIcon("image\\imagesOKM\\TenMapOKM.png").getImage();
            playerImageOKM = new ImageIcon("image\\imagesOKM\\BoyOKM.png").getImage(); 
            playerDeadImageOKM = new ImageIcon("image\\imagesOKM\\P_DIE.png").getImage();
            bossImageOKM = new ImageIcon("image\\imagesOKM\\BossOKM.png").getImage(); 

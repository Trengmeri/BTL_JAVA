...
public class stand_left extends JPanel {
    ...
    public stand_left() {
        // Load sprite sheet
        ImageIcon icon = new ImageIcon("D:\\Kunny_1\\Kunny_1\\src\\main\\java\\animation\\character\\P_STAND.png");
    ...
    private void scaleSpriteSheet() {
        ...
        scaledFrameWidth = frameWidth / 9; // Giảm chiều rộng của khung hình
        scaledFrameHeight = frameHeight / 9; // Giảm chiều cao của khung hình

...
public class stand_left extends JPanel {
    private BufferedImage spriteSheet;
    private int currentFrame = 0;
    private int frameWidth, frameHeight;
    private int numFrames = 1; // Số lượng khung hình trong sprite sheet
    private int frameDelay = 150; // Độ trễ giữa các khung hình (milliseconds)
    ...
    public stand_left() {
        // Load sprite sheet
        ImageIcon icon = new ImageIcon("C:\\Users\\Admin\\Desktop\\JAVA\\BTL\\TÀI NGUYÊN\\character\\4.png");
    ...
    private void scaleSpriteSheet() {
        ...
        scaledFrameWidth = frameWidth / 11; // Giảm chiều rộng của khung hình
        scaledFrameHeight = frameHeight / 11; // Giảm chiều cao của khung hình
